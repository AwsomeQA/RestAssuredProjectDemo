...
public class AssertAction {
	 ...
	 public void verifyStatusLine(Response response) {
	        assertEquals(String.valueOf(response.getStatusLine()).contains("HTTP/1.1 201 Created"),true,"value of status Line is" + response.getStatusLine());
